  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <header className="px-6 lg:px-16 py-16 border-b border-white/5">
                      ...
                      <div className="flex-grow space-y-6">
                        ...
                        <div className="flex gap-8 pt-6 border-t border-white/5 text-[10px] font-black uppercase tracking-[0.3em]">
                          <div className="flex flex-col gap-1">
                            <span className="text-[7px] opacity-20">Project Id</span>
                            <span className="flex items-center gap-2"><Eye size={12} style={{ color: theme.primary, textTransform: 'lowercase'}} /> {project.id}</span>
                          </div>
                          <div className="flex flex-col gap-1">
